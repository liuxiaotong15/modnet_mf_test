...
for i,f in enumerate(folds):
    ...
    model_denoiser = MODNetModel.load('out/MODNet_onion_{}_ph5'.format(i+1))
    # assure no overlap
    ...
    md = MD_append_and_set(train, [md_pbe, md_hse, md_gllb, md_scan], model_denoiser)
    ...
    model.save('out/MODNet_onion_cleaned_{}_ph1'.format(i+1))
    ...
    model.save('out/MODNet_onion_cleaned_{}_ph2'.format(i+1))
    ...
    model.save('out/MODNet_onion_cleaned_{}_ph3'.format(i+1))
    ...
    model.save('out/MODNet_onion_cleaned_{}_ph4'.format(i+1))
    ...
    model.save('out/MODNet_onion_cleaned_{}_ph5'.format(i+1))
